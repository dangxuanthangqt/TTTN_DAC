...
function ModalEdit(props) {
  ...
  const { handleCloseEdit, openEdit } = props;
  const handleCancel = () => {
    handleCloseEdit();
  };
    ...
    >
      <Fragment>
        <Formik
          ...
          initialValues={{
            name: dataEdit.name,
            start_date: new Date(dataEdit.start_date),
            end_date: new Date(dataEdit.end_date),
            budget: dataEdit.budget,
            bid_amount: dataEdit.bid_amount,
            title: dataEdit.title,
            description: dataEdit.description,
            final_url: dataEdit.final_url,
          }}
          ...
          onSubmit={(values) => {
            values = { ...dataEdit, ...values };
            dispatch(Edit_campaign_request(values));
            handleCloseEdit();
          }}
        >
          {(props) => {
